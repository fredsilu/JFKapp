...
import { Plus, Clock, MapPin, ChevronRight, DollarSign as Dollar } from 'lucide-react-native';
          ...
          <TouchableOpacity 
              ...
              <View>
                ...
                <View style={styles.orderMeta}>
                  <Text style={styles.orderItems}>
                    {order.dishes.reduce((total, dish) => total + dish.quantity, 0)} items
                  </Text>
                  <View style={styles.priceContainer}>
                    <Dollar size={16} color="#007AFF" />
            ...
            <View style={styles.orderDetails}>
              <View style={styles.detailRow}>
                ...
                <Text style={styles.detailText}>Delivery at {order.deliveryTime}</Text>
              </View>
              <View style={styles.detailRow}>
