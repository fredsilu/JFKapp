...
import { Search, Plus, DollarSign as Dollar, CircleAlert as AlertCircle } from 'lucide-react-native';
  ...
  return (
    <View style={styles.container}>
                  ...
                  <View 
                    style={[
                      ...
                      { 
                        ...
                        backgroundColor: ingredient.stock < 20 ? '#FF3B30' : '#4CAF50'
                      }
                    ]} 
                  />
                </View>
      ...
      <Modal visible={isModalVisible}>
        <IngredientForm onClose={() => setIsModalVisible(false)} />
      </Modal>
    </View>
  );
}
